...
(assuming you have files for pprof located in github.com/michal-kowalcze/pprof-server within go's src folder)

```
$ go-fuzz-build github.com/michal-kowalcze/pprof-server/fuzz
```
